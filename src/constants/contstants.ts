export const PRODUCTION = import.meta.env.NODE_DEV === 'production'
export const HOSTNAME = window.location.hostname
export const PROXY_PORT = import.meta.env.VITE_PROXY_PORT

export const STYRKELOFT_URL = 'https://styrkeloft.no/'
export const PROXY_URL = PRODUCTION ? STYRKELOFT_URL : `http://${HOSTNAME}:${PROXY_PORT}/proxy`
...
export const RECORDS = `${PROXY_URL}/resultatservice/?id=13&page=klubb_ranking&top=1&format=feed&type=rss`
